package com.stsinghua.config.controller;

import javax.validation.Valid;

import com.stsinghua.config.domain.User;
import com.stsinghua.config.util.CheckUtil;
...
import com.stsinghua.config.repository.UserRepository;
